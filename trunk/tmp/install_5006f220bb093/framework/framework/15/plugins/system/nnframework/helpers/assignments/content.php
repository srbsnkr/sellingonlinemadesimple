				...
				switch ( $main->_params->view ) {
					...
					default:
						...
						if ( $article->catid ) {
							...
							$catid = JRequest::getInt( 'catid', $mainframe->getUserStateFromRequest( 'com_content.viewcontentcatid', 'catid', 0, 'int' ) );
							$sectionid = JRequest::getInt( 'filter_sectionid', $mainframe->getUserStateFromRequest( 'com_content.viewcontentsectionid', 'sectionid', 0, 'int' ) );
							if ( $catid && $catid !== -1 ) {
