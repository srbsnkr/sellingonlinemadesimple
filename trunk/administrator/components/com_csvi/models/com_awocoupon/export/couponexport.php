					...
					foreach ($export_fields as $column_id => $field) {
						...
						switch ($fieldname) {
							...
							case 'product_sku':
								...
								$this->addExportField($field->combine, $product_sku, $fieldname, $field->column_header, true);
								break;
							case 'manufacturer_name':
								$query = $db->getQuery(true);
								...
								$this->addExportField($field->combine, $manufacturer_name, $fieldname, $field->column_header, true);
								break;
							case 'username':
								// Get all linked product SKUs
								$query = $db->getQuery(true);
								...
								$this->addExportField($field->combine, $username, $fieldname, $field->column_header, true);
								break;
							case 'shoppergroup':
								// Get all linked product SKUs
								$query = $db->getQuery(true);
								...
								$this->addExportField($field->combine, $usergroup, $fieldname, $field->column_header, true);
								break;
							case 'coupon_value':
								if (!empty($fieldvalue)) {
