 ...
 * coupon Table class
 */
class JmsTablecoupon extends JTable
{
	/**
	 * Constructor
	 *
	...
	{
		parent::__construct('#__jms_coupons', 'id', $db);
	}
	...
	public function bind($array, $ignore = '')
	{
		...
		if (isset($array['plan_ids']) && is_array($array['plan_ids'])) {
			$registry = new JRegistry();
			$registry->loadArray($array['plan_ids']);
			$array['plan_ids'] = (string)$registry;
		}
