 ...
 * @version 	$Id: userinfoimport.php 1970 2012-04-18 22:22:49Z RolandD $
 */
...
class CsviModelUserinfoimport extends CsviModelImportfile {
	...
	public function getProcessRecord() {
		...
		// Check the data for the userinfo_id
		if (!$this->_userinfos->check()) {
			$csvilog->AddStats('incorrect', JText::_('COM_CSVI_NO_USERINFO_ID_CREATED'));
			return false;
		}
